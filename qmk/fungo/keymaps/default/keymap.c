...
*/
  ...
  */
  ...
  // KC_LANGUAGE_2 	KC_LNG2 	Hanja
    ...
    KC_LCTL,    KC_Z,        KC_X,       KC_C,         KC_V,         KC_B,    A(KC_LEFT),   TT(SAM3),   KC_NO,     KC_NO, TT(SAM2),  KC_LNG1,  KC_N,  KC_M,   KC_COMM, KC_DOT,  KC_SLSH,  KC_RCTL,
    ...
    KC_LCTL,    LCTL(KC_Z), LCTL(KC_X),  LCTL(KC_C),   LCTL(KC_V),   KC_NO,   A(KC_RIGHT),  TT(SAM3),  KC_NO,     KC_NO, TT(SAM2), KC_LNG2, KC_BSLS, KC_QUOT, KC_LBRC, KC_RBRC,  KC_GRV,  KC_RCTL,
    KC_NO,      TT(SAM1),   KC_NO,       KC_LALT,             KC_SPC,         TT(SAM2),     KC_ENT,    MO(SAM4),  KC_NO, KC_ENT,   TT(SAM3),    KC_SPC,       KC_RALT, KC_NO,   TT(SAM1), KC_NO
  ),  
